...
Then proceed to Step 3 to populate the non-skill files (`CLAUDE.md`, `cv/resume.tex` + `cv/sections/`, `.claude/skills/scrape/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 8. Generate `.claude/skills/scrape/search-queries.md`
...
> - `.claude/skills/scrape/search-queries.md` - Job search queries for `/scrape`
>
> **Try it out:**
